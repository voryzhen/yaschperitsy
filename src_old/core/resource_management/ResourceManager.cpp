...
ResourceManagerSPtr ResourceManager::_rm;
std::unordered_map<std::string_view, ResourceSPtr>
...
//         _button_textures.insert({name, {_texture,
//         _texture_on_hover}});
//     }
// }
...
// TTF_Font* ResourceManager::load_font(const std::string_view&
// filename)
// {
