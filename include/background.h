...
{
    public:
        Background(SDL_Texture* background, SDL_Texture* explosion,
        ...
        SDL_Texture* get_texture() { return _background; }

        void render(SDL_Renderer* renderer)
        {
            SDL_Rect dest = {0, 0, _field_width, _field_height};
            SDL_RenderCopy(renderer, _background, NULL, &dest);
            // make explosions
        }
    ...
    private:
        ...
        SDL_Texture* _explosion{nullptr};
